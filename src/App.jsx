...
import imgUaGlobalLeader from './assets/events/ua-global-leader.jpg';
import imgInnotecs from './assets/events/innotecs.jpg';
import imgTedxMain from './assets/events/tedx-main.jpg';
import imgTedxSalon from './assets/events/tedx-salon.jpg';
import imgSeedTech from './assets/events/seed-tech-transfer.jpg';
import imgUnionSrs from './assets/events/union-srs.jpg';
import imgIeuaInvestSeed from './assets/events/ieua-invest-seed.jpg';
import imgSimCircuit from './assets/events/sim-circuit-aveiro.jpg';
import imgUaTechTransfer from './assets/events/ua-tech-transfer.jpg';
import imgEstiemTeamup from './assets/events/estiem-teamup.jpg';
import imgCldsFormacao from './assets/events/clds-formacao.jpg';
import imgTedxAveiro from './assets/events/tedxaveiro.jpg';
import imgAimFurther from './assets/events/aim-further.jpg';
import imgCompetencias from './assets/events/competencias-pos-2020.jpg';
import imgPigo from './assets/events/pigo.jpg';
...
export default function EntropicWebsite() {
  ...
  const programs = [
    ...
    {
      partner: 'IEUA — Instituto Empresarial da Universidade de Aveiro',
      title: 'Invest Seed',
      subtitle: 'Investor-Readiness Session for University Spin-offs',
      date: 'November 2024',
      audience: 'Founders & Early-Stage Investors',
      description: 'A working session for IEUA’s Invest Seed cohort on turning deep-tech research into an investable proposition — market sizing, traction signals and the pitch narrative that gets a spin-off its first cheque.',
      image: imgIeuaInvestSeed,
      imagePosition: 'center 60%'
    },
    {
      partner: 'Startup Portugal — SIM Circuit',
      title: 'Green & Digital Vouchers Showcase',
      subtitle: 'Mentoring Circuit for Startups, Aveiro',
      date: 'December 2023',
      audience: 'Startups & Scale-ups',
      description: 'Part of Startup Portugal’s national SIM Circuit, mentoring startups navigating the Green & Digital Vouchers programme — helping founders turn a compliance requirement into a genuine product roadmap.',
      image: imgSimCircuit,
      imagePosition: 'center 27%'
    },
    {
      partner: 'University of Aveiro — UA TransferTec',
      title: 'Vigilância Tecnológica & the Tech Transfer Pipeline',
      subtitle: 'Opening Session, UA TransferTec 2022',
      date: 'October 2022',
      audience: 'Researchers & Tech Transfer Officers',
      description: 'Opening the university’s TransferTec programme with a session on technology watch and IP commercialisation — how researchers spot which of their own results are actually worth protecting and selling.',
      image: imgUaTechTransfer,
      imagePosition: 'center 38%'
    },
    {
      partner: 'ESTIEM Local Group Aveiro',
      title: '"Wanna Be an Entrepreneur?"',
      subtitle: 'Team Up — Panel for Engineering Students',
      date: 'May 2022',
      audience: 'Engineering & STEM Students',
      description: 'A panel for ESTIEM’s engineering students on what building 24 startups actually teaches you — less about the wins, mostly about the associations, patents and dead ends that taught more.',
      image: imgEstiemTeamup,
      imagePosition: 'center 88%'
    },
    {
      partner: 'CLDS — Contrato Local de Desenvolvimento Social',
      title: 'Try. Fail. Learn. Repeat.',
      subtitle: 'Entrepreneurship Bootcamp for Young Founders',
      date: 'March 2022',
      audience: 'Young & First-Time Entrepreneurs',
      description: 'A hands-on bootcamp for young, first-time founders in the Aveiro region — reframing failure as the fastest route to a working venture, not a reason to quit before the first real attempt.',
      image: imgCldsFormacao,
      imagePosition: 'center 30%'
    },
    {
      partner: 'TEDxAveiro',
      title: 'On Building 24 Startups',
      subtitle: 'A TEDx Talk on Serial Entrepreneurship',
      date: 'May 2016',
      audience: 'General Public',
      description: 'One of the earliest TEDx stages for this material — unpacking the pattern behind a decade of company-building, and why repetition, not genius, is what actually compounds.',
      image: imgTedxAveiro,
      imagePosition: 'center 20%'
    },
    {
      partner: 'PCI Aveiro — Creative Science Park',
      title: 'Aim Further',
      subtitle: '7 Good Reasons Why (Not!) — Panel on Entrepreneurship',
      date: 'February 2020',
      audience: 'Founders & Innovation Community',
      description: 'A panel at PCI Aveiro’s Aim Further on the excuses that keep good ideas on the shelf — the seven reasons people give for not starting, none of which hold up under scrutiny.',
      image: imgAimFurther,
      imagePosition: 'center 25%'
    },
    {
      partner: 'Europe Direct Aveiro — Citizens Projects',
      title: 'Competências Pós 2020',
      subtitle: 'O Digital, a Economia Circular, o Green Deal e a Desinformação',
      date: 'December 2020',
      audience: 'Citizens & Civic Leaders',
      description: 'An EU-funded online conference on the skills the next decade would actually demand — digital literacy, the circular economy, the Green Deal and the fight against disinformation — months before most of this was mainstream conversation.',
      image: imgCompetencias
    },
    {
      partner: 'PiGo — AEAAV, Albergaria-a-Velha',
      title: 'Reinvention as a Skill',
      subtitle: 'PiGo 2025 "Inspiração" — Funded under Pessoas 2030',
      date: 'March 2025',
      audience: 'Local Workforce & Business Community',
      description: 'A stage talk for AEAAV’s PiGo inspiration series, held under Portugal’s Pessoas 2030 skills and qualification programme — making the case that reinvention is a trainable capability for a region’s workforce, not a trait only some people are lucky enough to have.',
      image: imgPigo,
      imagePosition: 'center 15%'
    }
  ];
      ...
      <section id="programs" className="py-24 px-4 border-b border-neutral-200 bg-neutral-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {programs.map((p, idx) => (
              <div key={idx} className="bg-white border border-neutral-200 flex flex-col h-full hover:border-neutral-900 transition overflow-hidden">
                {p.image && (
                  <div className="w-full h-56 overflow-hidden bg-neutral-100">
                    <img src={p.image} alt={p.title} className="w-full h-full object-cover" style={{ objectPosition: p.imagePosition || 'center' }} />
                  </div>
                )}
