...
const programs = [
  ...
  },
  {
    ...
    title: 'Do ADN a IA',
    subtitle: 'A historia de uma especie obsoleta?',
    date: 'March 2025',
  ...
  {
    partner: 'Escola Profissional Joao de Barros',
    title: 'Fear Factor',
...
return (
  ...
  <span className="hidden sm:block text-sm font-semibold tracking-[0.2em] uppercase text-neutral-900">Entropic Ventures</span>span>
  </a>a>
  
  <div className="hidden md:flex items-center gap-10 text-sm font-medium tracking-wide uppercase">
  <a href="#programs" className="hover:text-neutral-500 transition">Programs</a>a>
  <a href="#audiences" className="hover:text-neutral-500 transition">Who We Train</a>a>
  <a href="#services" className="hover:text-neutral-500 transition">Services</a>a>
  <a href="#contact" className="border border-neutral-900 px-5 py-2 hover:bg-neutral-900 hover:text-white transition">Contact</a>a>
  </div>div>
  ...
  <button className="md:hidden" onClick={() => setIsMenuOpen(!isMenuOpen)}>
    ...
    <a href="#programs" className="block py-2">Programs</a>a>
    <a href="#audiences" className="block py-2">Who We Train</a>a>
    <a href="#services" className="block py-2">Services</a>a>
    <a href="#contact" className="block py-2">Contact</a>a>
    </div>div>
  )}
  </div>div>
  </nav>nav>
  ...
  <p className="text-sm font-semibold tracking-[0.3em] uppercase text-neutral-500 mb-6">Training for the AI Transition</p>p>
  ...
  Entropic Ventures designs and delivers transformational training on AI, creativity and adaptive leadership - for PhD researchers, entrepreneurs, investors, executives and citizens alike. From university auditoriums to the TEDx stage.
  </p>p>
  ...
  <h2 className="text-4xl md:text-5xl font-bold tracking-tight">Who We Transform</h2>h2>
  <p className="text-neutral-500 max-w-sm">One methodology, four audiences - because the same blind spots slow down a lab, a boardroom and a classroom.</p>p>
  </div>div>
  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-neutral-200">
    ...
    <span className="block text-5xl font-bold text-neutral-200 mb-6">0{idx + 1}</span>span>
    <h3 className="text-lg font-bold mb-3">{a.title}</h3>h3>
    <p className="text-neutral-600 text-sm leading-relaxed">{a.description}</p>p>
    </div>div>
    ))}
  </div>div>
  </div>div>
  ...
  <div className="max-w-7xl mx-auto">
  <div className="mb-16">
  <p className="text-sm font-semibold tracking-[0.3em] uppercase text-neutral-500 mb-4">Selected Track Record</p>p>
  <h2 className="text-4xl md:text-5xl font-bold tracking-tight max-w-3xl">Signature Training Programs</h2>h2>
  </div>div>
  <div className="grid md:grid-cols-2 gap-8">
    ...
    <p className="text-xs font-bold uppercase tracking-wider text-neutral-500">{p.partner}</p>p>
    <span className="text-xs font-semibold uppercase tracking-wide text-neutral-400 whitespace-nowrap">{p.date}</span>span>
    </div>div>
    <h3 className="text-2xl font-bold mb-1">{p.title}</h3>h3>
    <p className="text-sm text-neutral-500 italic mb-4">{p.subtitle}</p>p>
    <p className="text-neutral-600 leading-relaxed mb-6 flex-1">{p.description}</p>p>
    <span className="inline-block self-start text-xs font-bold uppercase tracking-wider bg-neutral-900 text-white px-3 py-1.5">{p.audience}</span>span>
    </div>div>
    ))}
  </div>div>
  </div>div>
  ...
  <p className="text-sm font-semibold tracking-[0.3em] uppercase text-neutral-500 mb-6">Our Approach</p>p>
  ...
  <div className="max-w-7xl mx-auto">
  <div className="mb-16">
  <p className="text-sm font-semibold tracking-[0.3em] uppercase text-neutral-500 mb-4">Beyond Training</p>p>
  <h2 className="text-4xl md:text-5xl font-bold tracking-tight">Consulting & Advisory Services</h2>h2>
  </div>div>
  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-neutral-200">
    {services.map((service, idx) => (
    <div key={idx} className="bg-white p-8 hover:bg-neutral-50 transition">
    <h3 className="text-base font-bold mb-3">{service.title}</h3>h3>
    <p className="text-neutral-600 text-sm leading-relaxed">{service.description}</p>p>
    </div>div>
    ))}
  </div>div>
  </div>div>
  ...
  <div className="max-w-7xl mx-auto">
  <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-16 text-center">Bring This to Your Organisation</h2>h2>
  <div className="grid md:grid-cols-3 gap-12">
  <div className="text-center">
  <MapPin className="w-8 h-8 mx-auto mb-4 text-neutral-400" />
  <h3 className="text-sm font-bold uppercase tracking-wide mb-2">Location</h3>h3>
  <p className="text-neutral-400">Rua da India no 4 - 3o andar<br/>3080-137 Figueira da Foz, Portugal</p>p>
  </div>div>
  <div className="text-center">
  <Mail className="w-8 h-8 mx-auto mb-4 text-neutral-400" />
  <h3 className="text-sm font-bold uppercase tracking-wide mb-2">Email</h3>h3>
  <p className="text-neutral-400"><a href="mailto:contact@entropic.pt" className="hover:text-white transition">contact@entropic.pt</a>a></p>p>
  </div>div>
  <div className="text-center">
  <Phone className="w-8 h-8 mx-auto mb-4 text-neutral-400" />
  <h3 className="text-sm font-bold uppercase tracking-wide mb-2">Phone</h3>h3>
  <p className="text-neutral-400">+351 914 553 201</p>p>
  </div>div>
  </div>div>
  </div>div>
  </section>section>
  ...
  <p>&copy; 2026 Entropic Ventures Unipessoal Lda. All rights reserved.</p>p>
  <p>NIF: 513 896 678 | Figueira da Foz, Portugal</p>p>
  </div>div>
  </footer>footer>
  </div>div>
  );
